...
<details>
<summary>015. 분수/퍼센트 수일치</summary>

### 📌 핵심 개념 요약
- **분수/퍼센트 + of + 명사**의 수일치는 **of 뒤 명사의 수(단/복수)**에 따라 결정된다.  
- **전체를 하나로 보는 경우(물질명사, 단수 취급)** → 단수 동사  
- **구성요소가 여러 개인 경우(복수명사)** → 복수 동사

---

### ✅ 예문 + 해설

1) **Three quarters of the earth's surface *is*** water.  
→ *earth's surface* = 단수 → **is**

2) The rest of the **apples** **_has/have_** gone bad.  
→ apples = 복수 → **has / have 둘 다 가능** (의미 차이 없음)

3) **Any of the books *are*** logically consistent.  
→ books = 복수 → 복수동사 **are**

4) All of the **information *is*** released by the government.  
→ information = 불가산명사(단수취급) → **is**

5) Half (of) the **students *were*** transmitted to other schools.  
→ students = 복수 → **were**

6) Most of the **cake *was*** eaten by the dogs.  
→ cake = 단수 → **was**

7) One percent of the **students *are*** Asian at the school.  
→ students = 복수 → **are**

8) 99 percent of the **total water *is*** salty.  
→ water = 불가산명사 → **is**

</details>

<details>
<summary>017. 도치문장 수일치</summary>

### 📌 핵심 개념 요약
- 장소/부사구 + 동사 + 주어(도치) 구조에서도  
  **동사는 실제 주어의 수(단/복수)**에 맞춘다.  
- There is/are, There seems/appear 등도 **뒤 주어가 기준**.

---

### ✅ 예문 + 해설

1) Over the hill **_are_ beautiful houses**.  
→ 주어 = houses(복수) → **are**

2) In front of the building **_were_ several Italian restaurants**.  
→ restaurants(복수) → **were**

3) Among this year's Nobel laureates **_is_ a Japanese**.  
→ a Japanese(단수) → **is**

4) There **_appears_ to be** an interesting trait in his character.  
→ trait(단수) → **appears**

5) There **_lie_ five feasible solutions** to the problem.  
→ solutions(복수) → **lie**

6) There **_is_ a boy**.  
→ boy(단수) → **is**

7) There **_are_ two boys**.  
→ boys(복수) → **are**

8) There **_seem_ to be two boys**.  
→ boys(복수) → **seem**

9) There **_seems_ to be a boy**.  
→ boy(단수) → **seems**
...
<details>
<summary>018. 수일치 기타</summary>

### 📌 핵심 개념 요약
- **Many a + 단수명사 + 단수동사**  
- **Many + 복수명사 + 복수동사**  
- **More than one + 단수명사 + 단수동사**  
- **A number of + 복수명사 + 복수동사**  
- **The number of + 복수명사 + 단수동사**  
- **시간/거리/금액 등은 하나의 단위 = 단수 취급**

---

### ✅ 예문 + 해설

1) Many a **students → student** **_is_** proud of the school.  
→ Many a + 단수명사 + 단수동사

2) Many **men _are_** working hard.  
→ Many + 복수명사 → 복수동사

3) Many a **man _is_** working hard.  
→ Many a + 단수명사 → 단수동사

4) More than one of the students **_are → is_** Korean in the group.  
→ More than one of + 복수명사 → **단수 동사 is**

5) More than one student **_was_** Korean in the group.  
→ 단수명사 student → 단수동사 was

6) One and a half years **_were → was_** spent on the construction.  
→ 하나의 기간 → 단수 취급

7) A year and a half **_was_** spent on the project.  
→ 단일 기간 → 단수 was

8) A number of cars **_are_** running on the highway.  
→ A number of + 복수명사 → 복수동사 are

9) The number of cars **_is_** increasing rapidly.  
→ The number(단수) → is

10) Many a mystery **_remain → remains_** unraveled.  
→ Many a + 단수명사 → 단수동사 remains

11) More than one teacher **_were → was_** willing to help the student.  
→ More than one + 단수명사 → 단수동사 was

12) 20 years **_are → is_** a long period for an ant.  
→ 시간(단일단위) → 단수 is

13) A year and a half **_were → was_** spent on the study.  
→ 단일 기간 → 단수 was

</details>

<details>
<summary>019. 대명사 일치 (1)</summary>

### 📌 핵심 개념 요약
- **대명사는 선행사의 수(단/복수)**와 반드시 일치해야 한다.  
- 비교할 대상이 단수인지 복수인지 항상 확인.

---

### ✅ 예문 + 해설

1) Things often seem to be at **_its → their_** worst just before they get better.  
→ Things = 복수 → **their**

2) In spite of **_their → its_** close location to these countries, Korea has remained free of the deadly disease.  
→ Korea = 단수 → **its**

3) …ways to protect **_them → it_**.  
→ 보호 대상 = the environment(단수) → **it**

4) …the ankle-high grass is greener than **_those → that_** on the other side.  
→ 비교 대상 = grass(단수) → **that**

5) professionals … obliged by **_its → their_** code of ethics…  
→ professionals = 복수 → **their**

</details>


<details>
<summary>020. 대명사 일치 (2)</summary>

### 📌 핵심 개념 요약
- 문장 전체에서 **대명사 시점(1인칭/3인칭), 수(단/복수)**를 일관되게 유지해야 한다.  
- one → one / you → you 로 통일.

---

### ✅ 예문 + 해설

1) Drama colleges not only enable **one** to practice acting, but also teach **_you → one_** how to write a short drama.  
→ one과 you 일치 필요 → **one으로 통일**

2) If **one** knows the facts, **_you → one_** would not be so quick to criticize.  
→ one 유지

3) …the coach and the team captain agreed not to talk until **_he → they_** **_was → were_** able…  
→ 복수 주어 → 복수대명사 they + 복수동사 were

4) One should try to avoid breaking rules… because **_you → one_** do not know whether you will be caught.  
→ one 유지

5) One does not have to be a master…, but studying with a master can certainly help **_you → one_** play with greater accuracy…  
→ one 유지
</details>
...
<details>
<summary>022. 현재 VS 현재진행</summary>

### 📌 핵심 개념 요약
- **현재 시제**: 변하지 않는 사실, 일반적인 진리, 반복되는 습관  
- **현재진행 시제**: 지금 일어나고 있는 일, 일시적·변화 중인 행동  
- **주의**: 소유의 *have*는 진행형 불가

---

### 1. The Sun (rises/is rising) in the east and (sets/is setting) in the west.  
**Answer: rises / sets**  
→ 해·달의 움직임 등 변하지 않는 일반적 진리는 **현재 시제** 사용.

### 2. She always (is/is being) nice.  
**Answer: is**  
→ *always*는 습관·성질을 나타내므로 **현재 시제** 사용.

### 3. Now, she (is/is being) nice to avoid any conflict with Tom.  
**Answer: is being**  
→ 일시적 행동 → **현재진행형**.

### 4. She (has/is having) the house with her husband.  
**Answer: has**  
→ *have = 소유* 의미일 때는 진행형 불가.

### 5. She (had/was having) a good time with her friends.  
**Answer: was having**  
→ *have a good time* = 경험·일시적 상황 → **진행형 가능**.

---

### ⚠️ 추가 정리
- **소유를 나타내는 have는 진행형 불가**

</details>


<details>
<summary>023. 시간/조건 부사절 시제</summary>

### 📌 핵심 개념 요약
1) 시간/조건 부사절에서는 **미래 의미여도 현재 시제 사용**  
2) 명사절(when/if가 절을 목적어·보어로 이끄는 경우)에서는 **미래 시제 그대로 사용**  

---

## 🔹 **① 시간/조건 부사절 (미래 → 현재시제)**

### When he (is/will be) back tomorrow, I will let you know his arrival.  
**Answer: is**  
→ 시간 부사절(When ~)에서는 미래 대신 **현재 시제**.

### If he (comes/will come) back, please let me know.  
**Answer: comes**  
→ 조건 부사절에서도 미래 대신 **현재 시제**.

---

## 🔹 **② 명사절 시제 (미래 시제 그대로 사용)**

### I don't know when he (is/will be) back tomorrow.  
**Answer: will be**  
→ *when*이 **목적어를 이끄는 명사절** → 미래시제 사용.

### I don't know the exact time when she (leaves/will leave) France tomorrow.  
**Answer: will leave**  
→ *when*이 **명사 time을 수식하는 관계부사절** → 미래시제 사용.

### I wonder if he (comes/will come) back soon tomorrow.  
**Answer: will come**  
→ *if*가 “~인지 아닌지” 의미의 **명사절** → 미래시제 사용.
...
<details>
<summary>025. for/over 완료시제</summary> 
 
 ## 📌 핵심 개념 요약
 for / over 뒤에는 완료시제를 쓴다
 --
 
 ### For the last five years, I have suffered cancer.
 ### Dver the previous few years, the President had focused on economic issues.


 </details>
 
 <details>
<summary>026. since 완료시제</summary> 
 
 ### 📌 핵심 개념 요약
 since 종속절은 과거시제, 주절은 완료시제
 --
 ##🔹 **since+점(과거),완료형 주절**

 ### *Since* the war, the country *has developed* significantly.
 ### *Since* the Korean War happend, the country *had suffered* from lack of supplies until 1975.


 </details>

<details>
<summary>027. by 완료시제</summary>  

 ### 📌 핵심 개념 요약
 by시점, 완료절
--
 ### *By* 2030, Korea`s population will *have surfassed* 60 million. 

+ 숫자 단위 뒤에 **s** 붙는 경우 / 안 붙는 경우 정리

#### ✅ s 붙는 경우: **수량 자체를 말할 때(명사)**
- 수량이 **주어·목적어**처럼 **명사 역할**을 할 때  
- **of + 명사** 구조에서 사용됨  
- **반드시 s 붙음**
...
#### ✅ s 안 붙는 경우: **명사를 꾸밀 때(형용사)**
- 숫자 + 단위가 하나의 덩어리로 **명사를 수식**할 때  
- **단위는 단수형 유지**

**예시**
- a 5 million dollar deal  
- a 3 million person city  
...
- **명사로 쓰이면 → s 붙음**  
  - 예: *millions of people*

- **형용사처럼 명사를 꾸미면 → s 안 붙음**  
  - 예: *a 5 million dollar deal*
</details>

<details>
 <summary>028. before완료시제</summary>
 ### 📌 핵심 개념 요약
 before 완료, ago 단순 과거
 --
 ### He *studied* in France 5 years *ago*.
 ### He *had studied* in France *before*.
 --
 ###예제)
 - I once *read* the book *before*
 ->I *have once read* the book *before*.
